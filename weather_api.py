...
weather_info_jason = weather_info.json()
temp = weather_info_jason["main"]["temp"]
temp_max = weather_info_jason["main"]["temp_max"]
temp_min = weather_info_jason["main"]["temp_min"]
